...
const uri = "mongodb+srv://smartphoneuser:j5Jhr6iW4VeAtJK6@cluster0.hpovn.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
...
async function run() {
  try {
    ...
    const database = client.db("smartphone");
    const productCollection = database.collection("smartphoneCollection");
